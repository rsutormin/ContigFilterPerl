package ContigFilterPerl::ContigFilterPerlImpl;
use strict;
...
A KBase module: ContigFilterPerl
...
sub new
{
    ...
    my $wsInstance = $cfg->val('ContigFilterPerl','workspace-url');
...
<pre>
$workspace_name is a ContigFilterPerl.workspace_name
$contigset_id is a ContigFilterPerl.contigset_id
...
sub filter_contigs
{
    ...
    my $ctx = $ContigFilterPerl::ContigFilterPerlServer::CallContext;
    my($return);
